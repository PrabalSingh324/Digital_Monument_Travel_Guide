"""
Django settings for Digital_Monument_Travel_Guide project.
...
ROOT_URLCONF = 'Digital_Monument_Travel_Guide.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "explorebharat" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Digital_Monument_Travel_Guide.wsgi.application'
...
# CSS FOlder
STATICFILES_DIRS = [
    BASE_DIR / "explorebharat" / "static",
]

# Media Files ... Admin will upload images
MEDIA_URL = '/media/'
